            ...
            <form action="{{route('historias.store')}}" method="post" >
                ...
                <div class="form-row">
                     <div class="form-group col-md-6">
                        ...
                        <input type="date" name="fechanaci" class="form-control"  value="" id="nombre" required>

                        <label for="telefono">Ingresar Ocupacion</label>
                        <input type="text" name="ocupacion" class="form-control"  value="" id="telefono" required>

                        <label for="edad">Ingresar Estado civil</label>
                        <input type="text" name="estadocivil" class="form-control"  value="" id="telefono" required>
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="inspecciongeneral" class="form-control"  value="" id="telefono" required>
                        </div>

                        <div class="form-group">
                            <label for="pulmonar">Peso:</label>
                            <input type="text" name="peso" class="form-control"  value="" id="telefono" required>
                        </div>

                        <div class="form-group">
                            <label for="digestivo">Altura:</label>
                            <input type="text" name="altura" class="form-control"  value="" id="telefono" required>
                        </div>

                        <div class="form-group">
                            <label for="renales">Temperatura:</label>
                            <input type="text" name="temperatura" class="form-control"  value="" id="telefono" required>
                        </div>

                        <div class="form-group">
                            <label for="quirurgico">Aspecto:</label>
                            <input type="text" name="aspecto" class="form-control"  value="" id="telefono" required>
                        </div>
                ...
                <div class="form-group">
                    <button  class="btn btn-primary" type="submit" value="required">Añadir Historias</button>
